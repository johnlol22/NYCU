    ...
    def train(self):
        ...
        while self.total_time_step <= self.training_steps:
            ...
            while True:
                ...
                self.gae_replay_buffer.append(0, {   #path[trajectory[{obs1, reward1, logp1}, {{ob2, reward2, logp2},...,done}, trajectory2[{obs1, reward1, logp1}, {ob2, reward2, logp2}, ..., done]]]
            ...
            #output_name = "./output2/output_"+str(episode_reward)
            #self.createVideo(frames, 60, output_name)
