...
class DQNBaseAgent(ABC):
	...
	def train(self):
		...
		while self.total_time_step <= self.training_steps:
			...
			output_name = "./output/output_" + str(episode_reward)
			self.create_video(frames, 60, output_name)
	...
	def evaluate(self):
		...
		for i in range(self.eval_episode):
			observation, info = self.test_env.reset() #observation is default env
			total_reward = 0
			while True:
	...
	def create_video(self, source, fps, output_name):
