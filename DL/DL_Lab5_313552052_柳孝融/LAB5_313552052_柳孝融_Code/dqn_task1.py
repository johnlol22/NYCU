...
if __name__ == "__main__":
    ...
    parser.add_argument("--save-dir", type=str, default="./results/cartpole4")
    parser.add_argument("--wandb-run-name", type=str, default="cartpole-run4")
    ...
    wandb.init(project="DLP-Lab5-DQN-CartPole4", name=args.wandb_run_name, save_code=True)
